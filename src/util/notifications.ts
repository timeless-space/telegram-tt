...
/**
 * TL - Declare a subscription functions that register app to receive push notifications
 */
...
/**
 * TL - Declare a subscription functions that unregister app from receive push notifications
 */
